...
{
    /// <inheritdoc />
    public partial class InitCareVantage : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubscriptionPricings_Subscriptions_SubscriptionId",
                        column: x => x.SubscriptionId,
                        principalTable: "Subscriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsageMetrics_UsageRecords_UsageRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionPricings_SubscriptionId",
                table: "SubscriptionPricings",
                column: "SubscriptionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UsageMetrics_UsageRecordId",
                table: "UsageMetrics",
